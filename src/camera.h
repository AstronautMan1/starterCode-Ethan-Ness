...
class Camera {
    ...
    public:
        ...
        Camera() : pos(0,0,0), U(1,0,0), V(0,1,0), W(0,0,1), focalLength(1.0f), imagePlane_Length(0.25f), imagePlane_Width(0.25f), nx(100), ny(100) {} // default constructor

        // camera pass in constructor
