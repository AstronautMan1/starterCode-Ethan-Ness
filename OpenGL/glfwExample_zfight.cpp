...
//  glClearColor(0.08, 0.08, 0.1, 1.0);
  ...
  // the GPU memory
  // normal vector is 0, 0, 1
  host_VertexBuffer = { -2.0f, -3.0f, 0.001f,// V0
                                        0.0, 0.0, 1.0,
                                        4.0f, -3.0f, 0.001f,// V1
                                        0.0, 0.0, 1.0,
                                        1.0f, 3.0f, 0.001f, // V2
  ...
  blinnPhong_shader.addShader( "fragmentShader_BlinnPhong.glsl", sivelab::GLSLObject::FRAGMENT_SHADER );
  ...
  sivelab::GLSLObject lambertian_shader;
  lambertian_shader.addShader( "vertexShader_PrepForPerFragment.glsl", sivelab::GLSLObject::VERTEX_SHADER );
  lambertian_shader.addShader( "fragmentShader_Lambertian.glsl", sivelab::GLSLObject::FRAGMENT_SHADER );
  lambertian_shader.createProgram();
...
//    }
    ...
    glm::mat4 perspMat = glm::perspective(3.14159f/4.0f, 1.0f, 0.01f, 100000.0f);
    ...
    // Pass shader data
    glm::vec3 diffuse = glm::vec4( 1.0f, 0.0f, 0.0f, 1.0f );
...
//    glm::vec3 cameraPos = glm::vec4(cam.getPosition(), 1.0f);
    ...
    // Pass shader data
    diffuse = glm::vec4( 0.0f, 1.0f, 0.0f, 1.0f );
    glUniform3fv(diffuseComponentID, 1, glm::value_ptr(diffuse));
